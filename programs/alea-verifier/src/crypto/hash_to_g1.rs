...
pub fn hash_to_g1(msg: &[u8]) -> [u8; 64] {
...
pub fn hash_round_to_g1(round: u64) -> [u8; 64] {
...
mod tests {
    ...
    fn hash_to_g1_round_1() {
        ...
        let m = hash_to_g1(&msg_hash);
        assert_eq!(hex::encode(&m[0..32]), "073d3d00a1c3ca588db79d44202e44b2f45995ddd39e705717c9edfcb79e4371");
        assert_eq!(hex::encode(&m[32..64]), "173e31a5208ea2594cbcb23b5afb3dd930719a4d1a3f877839bb8bdeb3c15084");
    }
    ...
    fn hash_round_to_g1_e2e_round_9337227() {
        let m = hash_round_to_g1(9337227);
        assert_eq!(hex::encode(&m[0..32]), "1626082c3dd0751bdaaf8c3e709b5dd7cdedf45d4e81a5aa3e270f1e78924b32");
        assert_eq!(hex::encode(&m[32..64]), "2bf29ab3af54dfe3c053ad4efa93db05d3586368463e9d7334c7ba61f6f4e955");
    }
}
